...
5. KW_ONLY sentinel values are supported as described in the Python
   docs [#kw-only-docs]_ and Python issue 43532 [#kw-only-issue]_.
...
.. [#kw-only-docs] https://docs.python.org/3/library/dataclasses.html#dataclasses.KW_ONLY
.. [#kw-only-issue] https://bugs.python.org/issue43532
